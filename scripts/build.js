...
function build(options = {}) {
  ...
  const searchConsole = jsonFile(path.join(root, "data/search-console.json"), {});
  const verificationToken = searchConsole.googleSiteVerification || "";
  if (verificationToken && !/^[A-Za-z0-9_-]{20,100}$/.test(verificationToken))
